...
RUN apt-get -y --no-install-recommends install zip mtools g++ gcc mingw-w64 make dos2unix python3 libncurses-dev bison flex wget curl git libncurses5-dev libreadline-dev autoconf automake texinfo libisl-dev gcc-multilib g++-multilib xz-utils make python3-pip cmake
